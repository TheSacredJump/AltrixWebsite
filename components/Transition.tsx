...
const ScrollTransitionContainer = () => {
  ...
  return (
    <div ref={sectionRef} className="relative h-[200vh]"> {/* Section height */}
      ...
      <div 
        ...
        style={{
          backgroundColor: `rgb(${Math.round(255 - (scrollPercentage*1.5 * 255))}, ${Math.round(255 - (scrollPercentage*1.5 * 255))}, ${Math.round(255 - (scrollPercentage*1.5 * 255))})`
        }}
      />
